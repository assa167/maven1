//Task 8.  Write a project named ""Remote Device"". Create a class ""RemoteController""
...
package com.company.World.ElectricDevices;

public abstract class TVDevices implements FunctionButtons {
    String modelName;
    boolean isOn;
